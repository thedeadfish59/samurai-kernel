...
*******************************************************************************/
//Disabled 936mhz for unstability
...
int bcm21553_arm11_set_rate(struct clk *clk, unsigned long val)
{
	...
	arm11_freq[0] = (apps_pll_freq*2)/16;	/*156 MHz*/
	arm11_freq[1] = (apps_pll_freq*2)/8;	/*312 MHz*/
	arm11_freq[2] = (apps_pll_freq*3)/8;	/*468 MHz*/
	arm11_freq[3] = (apps_pll_freq*2)/4;	/*624 MHz*/
//	arm11_freq[4] = (apps_pll_freq*5)/8;	/*780 MHz*/
	arm11_freq[4] = (apps_pll_freq*2)/3;	/*832 MHz*/
//	arm11_freq[5] = (apps_pll_freq*3)/4;	/*936 MHz*/
	arm11_freq[5] = (apps_pll_freq*5)/6;	/*1124 MHz*/
